--如果顶层为设计BOM,则子件全为设计
create or replace view cux_bom_3252SJ_v as
...
select wpl.IDA2A2 linkida2a2, --BOM关系唯一标识
  ...
  from plm.WTPartusageLink       wpl, --Bom关联信息表
       plm.WTPart                pwp, --父部件信息从表
       CUX_WTPARTMASTER_NO3252_V cwm, --子部件信息主表
