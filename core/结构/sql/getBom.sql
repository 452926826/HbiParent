...
select wpl.IDA2A2 linkida2a2, --BOM关系唯一标识 
 ...
 where wpl.IDA3A5 = pwp.IDA2A2
   ...
   and cwp.ITERATIONIDA2ITERATIONINFO =
       (select max(cwpm.ITERATIONIDA2ITERATIONINFO)
   ...
   and wpl.IDA3A5 = 2227773156
      --and cwp.ida2a2=2227773156
      --and wpl.IDA3A5 = 960251207
   and wpl.IDA2A2 = 2227773617
-- and cwm.NAME = '双面板'
/* and cwp.VERSIONIDA2VERSIONINFO || '.' || cwp.ITERATIONIDA2ITERATIONINFO =
'A.6'*/
;
